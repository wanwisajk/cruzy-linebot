    ...
    contents: {
      ...
      body: {
        ...
        contents: [
          ...
          command('#ตาราง วันนี้', 'ดูตารางงานของวันนี้'),
          command('#ตาราง พรุ่งนี้', 'ดูตารางงานของพรุ่งนี้'),
          command('#ตารางงาน', 'ดูตารางงาน 7 วันข้างหน้า'),
          command('#สาขา CCA', 'ผูกกลุ่ม LINE กับสาขา'),
          command('#พนักงาน EMP001', 'ผูก LINE กับพนักงาน'),
        ],
      },
    },
  };
